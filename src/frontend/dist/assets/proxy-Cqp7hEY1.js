...
import { P as ProtocolError, T as TimeoutWaitingForResponseErrorCode, p as utf8ToBytes, E as ExternalError, M as MissingRootKeyErrorCode, q as Certificate, s as lookupResultToBuffer, t as RequestStatusResponseStatus, U as UnknownError, v as RequestStatusDoneNoReplyErrorCode, w as RejectError, x as CertifiedRejectErrorCode, y as UNREACHABLE_ERROR, I as InputError, z as InvalidReadStateRequestErrorCode, A as ReadRequestType, D as Principal, F as IDL, G as MissingCanisterIdErrorCode, H as HttpAgent, J as encode, Q as QueryResponseStatus, K as UncertifiedRejectErrorCode, N as isV3ResponseBody, O as isV2ResponseBody, V as UncertifiedRejectUpdateErrorCode, W as UnexpectedErrorCode, X as decode, Y as Subscribable, Z as pendingThenable, _ as resolveEnabled, $ as shallowEqualObjects, a0 as resolveStaleTime, a1 as noop$1, a2 as environmentManager, a3 as isValidTimeout, a4 as timeUntilStale, a5 as timeoutManager, a6 as focusManager, a7 as fetchState, a8 as replaceData, a9 as notifyManager, aa as hashKey, ab as getDefaultState, r as reactExports, ac as shouldThrowError, u as useQueryClient, ad as useInternetIdentity, ae as createActorWithConfig, af as Variant, ag as Record, ah as Vec, ai as Service, aj as Func, ak as Opt, al as Nat, am as Null, an as Text, ao as Int, ap as Nat8, aq as Bool, j as jsxRuntimeExports } from "./index-OIp2ZZ2R.js";
...
const RecipeId = Nat;
const FlagId = Nat;
const FlagStatus = Variant({
  "otvoreno": Null,
  "rijeseno": Null
});
const ImprovementFlag = Record({
  "id": FlagId,
  "status": FlagStatus,
  "recipeId": RecipeId,
  "createdAt": Int,
...
const NoteId = Nat;
const CollabNote = Record({
  "id": NoteId,
  "recipeId": RecipeId,
  "createdAt": Int,
  "text": Text
});
const DietaryTag = Variant({
  "veganski": Null,
  "bezGlutena": Null,
  "vegetarijansko": Null
});
const Cuisine = Variant({
  "hrvatska": Null,
  "azijska": Null,
  "francuska": Null,
  "talijanska": Null,
...
Service({
  "addFlag": Func([RecipeId, Text], [ImprovementFlag], []),
  "addNote": Func([RecipeId, Text], [CollabNote], []),
  "createRecipe": Func([RecipeInput], [Recipe], []),
  "deleteNote": Func([NoteId], [Bool], []),
  "deleteRecipe": Func([RecipeId], [Bool], []),
  "getAllRecipes": Func([], [Vec(Recipe)], ["query"]),
  "getFlagsForRecipe": Func(
    [RecipeId],
    [Vec(ImprovementFlag)],
    ["query"]
  ),
  "getNotesForRecipe": Func([RecipeId], [Vec(CollabNote)], ["query"]),
  "getRecipe": Func([RecipeId], [Opt(Recipe)], ["query"]),
  "resolveFlag": Func([FlagId], [Bool], []),
  "suggestRecipes": Func(
    [Vec(Text), Vec(Text)],
    [Text],
    []
  ...
  "updateRecipe": Func([RecipeId, RecipeInput], [Bool], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  const RecipeId2 = IDL2.Nat;
  const FlagId2 = IDL2.Nat;
  const FlagStatus2 = IDL2.Variant({
    "otvoreno": IDL2.Null,
    "rijeseno": IDL2.Null
  });
  const ImprovementFlag2 = IDL2.Record({
    "id": FlagId2,
    "status": FlagStatus2,
    "recipeId": RecipeId2,
    "createdAt": IDL2.Int,
  ...
  const DietaryTag2 = IDL2.Variant({
    "veganski": IDL2.Null,
    "bezGlutena": IDL2.Null,
    "vegetarijansko": IDL2.Null
  });
  const Cuisine2 = IDL2.Variant({
    "hrvatska": IDL2.Null,
    "azijska": IDL2.Null,
    "francuska": IDL2.Null,
    "talijanska": IDL2.Null,
    "ostalo": IDL2.Null
  });
  const Category2 = IDL2.Variant({
    "deserti": IDL2.Null,
    "glavnaJela": IDL2.Null,
    "pica": IDL2.Null,
    "predjela": IDL2.Null
  });
  ...
  const RecipeInput2 = IDL2.Record({
    "title": IDL2.Text,
    "cookTime": IDL2.Nat,
    "steps": IDL2.Vec(IDL2.Text),
    "dietaryTags": IDL2.Vec(DietaryTag2),
    "cuisine": Cuisine2,
    "prepTime": IDL2.Nat,
    "category": Category2,
    "servings": IDL2.Nat,
    "ingredients": IDL2.Vec(Ingredient2)
  });
  ...
  return IDL2.Service({
    "addFlag": IDL2.Func([RecipeId2, IDL2.Text], [ImprovementFlag2], []),
    "addNote": IDL2.Func([RecipeId2, IDL2.Text], [CollabNote2], []),
    "createRecipe": IDL2.Func([RecipeInput2], [Recipe2], []),
    "deleteNote": IDL2.Func([NoteId2], [IDL2.Bool], []),
    "deleteRecipe": IDL2.Func([RecipeId2], [IDL2.Bool], []),
    "getAllRecipes": IDL2.Func([], [IDL2.Vec(Recipe2)], ["query"]),
    "getFlagsForRecipe": IDL2.Func(
      [RecipeId2],
      [IDL2.Vec(ImprovementFlag2)],
      ["query"]
    ),
    "getNotesForRecipe": IDL2.Func(
      [RecipeId2],
      [IDL2.Vec(CollabNote2)],
      ["query"]
    ),
    "getRecipe": IDL2.Func([RecipeId2], [IDL2.Opt(Recipe2)], ["query"]),
    "resolveFlag": IDL2.Func([FlagId2], [IDL2.Bool], []),
    "suggestRecipes": IDL2.Func(
      [IDL2.Vec(IDL2.Text), IDL2.Vec(IDL2.Text)],
      [IDL2.Text],
      []
    ),
    "transform": IDL2.Func(
    ...
    "updateRecipe": IDL2.Func([RecipeId2, RecipeInput2], [IDL2.Bool], [])
  });
};
class Backend {
  ...
  async suggestRecipes(arg0, arg1) {
    if (this.processError) {
      try {
...
function from_candid_Category_n21(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n22(_uploadFile, _downloadFile, value);
}
function from_candid_Cuisine_n19(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n20(_uploadFile, _downloadFile, value);
}
function from_candid_DietaryTag_n17(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n18(_uploadFile, _downloadFile, value);
}
function from_candid_FlagStatus_n3(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n4(_uploadFile, _downloadFile, value);
}
function from_candid_ImprovementFlag_n1(_uploadFile, _downloadFile, value) {
  return from_candid_record_n2(_uploadFile, _downloadFile, value);
}
function from_candid_Recipe_n14(_uploadFile, _downloadFile, value) {
...
function from_candid_variant_n18(_uploadFile, _downloadFile, value) {
  return "veganski" in value ? "veganski" : "bezGlutena" in value ? "bezGlutena" : "vegetarijansko" in value ? "vegetarijansko" : value;
}
function from_candid_variant_n20(_uploadFile, _downloadFile, value) {
  return "hrvatska" in value ? "hrvatska" : "azijska" in value ? "azijska" : "francuska" in value ? "francuska" : "talijanska" in value ? "talijanska" : "ostalo" in value ? "ostalo" : value;
}
function from_candid_variant_n22(_uploadFile, _downloadFile, value) {
  return "deserti" in value ? "deserti" : "glavnaJela" in value ? "glavnaJela" : "pica" in value ? "pica" : "predjela" in value ? "predjela" : value;
}
function from_candid_variant_n4(_uploadFile, _downloadFile, value) {
  return "otvoreno" in value ? "otvoreno" : "rijeseno" in value ? "rijeseno" : value;
}
...
function to_candid_Category_n12(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n13(_uploadFile, _downloadFile, value);
}
function to_candid_Cuisine_n10(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n11(_uploadFile, _downloadFile, value);
}
function to_candid_DietaryTag_n8(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n9(_uploadFile, _downloadFile, value);
}
function to_candid_RecipeInput_n5(_uploadFile, _downloadFile, value) {
